...
from a list someone keeps:
  ...
  prebuilt   a recorded download, installed unmodified -- a tarball, a payload, a file a
             script fetched -- or bytes pack copied from the build host (the MBR)
  built      compiled or assembled here: GRUB's EFI image, a busybox with a verified build
             claim, a binary a bundle.script declares
  ours       written or generated by a recipe or by kitchen itself
