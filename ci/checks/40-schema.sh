...
# "/usr/bin/env: 'python3': No such file or directory" -- 47 of them on 2026-09-20, for
# one cause. Said once now, here, before the file list is built -- which also costs the
# yamllint half on such a machine, and that is the trade: the gate is refusing either way.
