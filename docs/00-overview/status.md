...
runs as [`ci/tier-c.sh`](../60-testing/tier-c.md) on any KVM-capable host — which holds what it
costs — and has been run on **all four targets**: 20 boots, 18 green. The two
